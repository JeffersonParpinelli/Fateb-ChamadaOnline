...
?>
        ...
        <a href="form_alterar_CalendarioEventoo.php?id=<?php echo $id_calendarioEvento ?>" type="button" class="btn btn-primary pull-right">Alterar</a><br><br>
    <?php
    }
    ?>
    <?php
