                        ...
                        <div class="x_content" style="display: block;">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-6">
                                    ...
                                    <input name="descricao" type="text" id="descricao" onblur="this.value=this.value.toUpperCase();" class="form-control" required="" onkeydown="upperCaseF(this)" value="<?php echo $nome_curso ?>">
                                </div>
